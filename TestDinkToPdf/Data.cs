...
public class Data
{
    public static OfferMainInfoResponse MainInfo = new OfferMainInfoResponse
            {
                Id = 14,
                Name = "Test Offerta",
            ...
            public static OfferArticleSummaryResponse Articles = new OfferArticleSummaryResponse
            {
            ...
            public static OfferServicesSummaryResponse Services =  new OfferServicesSummaryResponse()
            {
